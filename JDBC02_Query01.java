...
public class JDBC02_Query01 {
    ...
    // ORNEK:  ID si   1 den buyuk firmalarin  ismini ve iletisim_isim ini isim ters sirali yazdirin
...
// ORNEK: iletisim  ISMINDE  'li' iceren firmalarin id lerini   ve ismini  id  sirali yazdirin
       ...
       // while (data2.next()){
         //   System.out.println(data2.getInt(1) +" " +
        //            data2.getString(2) );
       // }
